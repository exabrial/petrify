...
class SklearnRegressionHousingTest implements TestConstants {
	...
	void testPredict_0() {
		...
		assertEquals(0.985284686088562f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_1() {
		...
		assertEquals(1.246177077293396f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.159973621368408f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_3() {
		...
		assertEquals(1.9039111137390137f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_4() {
		...
		assertEquals(2.6132099628448486f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_5() {
		...
		assertEquals(2.066805601119995f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_6() {
		...
		assertEquals(1.806421160697937f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.8960392475128174f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_8() {
		...
		assertEquals(2.100045680999756f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.8947312831878662f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_10() {
		...
		assertEquals(4.411486625671387f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_11() {
		...
		assertEquals(2.240135431289673f, actual, PREDICTION_PRECISION);
	}
}
