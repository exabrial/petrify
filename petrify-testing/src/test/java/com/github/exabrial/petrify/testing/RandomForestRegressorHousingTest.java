...
class RandomForestRegressorHousingTest {
	...
	void testPredict_0() {
		...
		assertEquals(2.40881085395813f, actual, 0.01f);
	}
	...
	void testPredict_1() {
		...
		assertEquals(2.1682651042938232f, actual, 0.01f);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.417489767074585f, actual, 0.01f);
	}
	...
	void testPredict_3() {
		...
		assertEquals(1.997986078262329f, actual, 0.01f);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.0730961561203003f, actual, 0.01f);
	}
	...
	void testPredict_5() {
		...
		assertEquals(2.9265122413635254f, actual, 0.01f);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.566546678543091f, actual, 0.01f);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.8076063394546509f, actual, 0.01f);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.89700984954834f, actual, 0.01f);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.1958833932876587f, actual, 0.01f);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.7576334476470947f, actual, 0.01f);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.6530877351760864f, actual, 0.01f);
	}
}
