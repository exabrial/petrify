...
/**
 * Uses a scikit-learn RandomForestRegressor exported to ONNX via skl2onnx, trained on California housing data to predict median house
 * value (continuous). 30 estimators, max_depth=6, BRANCH_LEQ node mode, post_transform=NONE, aggregate_function=AVERAGE, 8 input
 * features (MedInc, HouseAge, AveRooms, AveBedrms, Population, AveOccup, Latitude, Longitude). 3,756 total nodes (1,863 branch + 1,893
 * leaf). R²=0.68.
 */
@TestInstance(Lifecycle.PER_CLASS)
class RandomForestRegressorHousingTest implements TestConstants {
	private static final String ONNX = "/test-models/randomForestRegressorHousing.onnx";
	...
	void testPredict_0() {
		...
		assertEquals(2.40881085395813f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_1() {
		...
		assertEquals(2.1682651042938232f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.417489767074585f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_3() {
		...
		assertEquals(1.997986078262329f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.0730961561203003f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_5() {
		...
		assertEquals(2.9265122413635254f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.566546678543091f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.8076063394546509f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.89700984954834f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.1958833932876587f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.7576334476470947f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.6530877351760864f, actual, PREDICTION_PRECISION);
	}
}
