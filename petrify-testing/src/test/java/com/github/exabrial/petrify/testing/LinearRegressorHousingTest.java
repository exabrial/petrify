...
/**
 * Uses a scikit-learn LinearRegression exported to ONNX via skl2onnx, trained on California housing data (raw median house value target,
 * not binned). ONNX operator: LinearRegressor, 8 input features (MedInc, HouseAge, AveRooms, AveBedrms, Population, AveOccup, Latitude,
 * Longitude), single-target regression, post_transform=NONE.
 */
...
class LinearRegressorHousingTest {
	...
	void testPredict_0() {
		...
		assertEquals(2.0340328216552734f, actual, 0.001f);
	}
	...
	void testPredict_1() {
		...
		assertEquals(2.08674955368042f, actual, 0.001f);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.282744884490967f, actual, 0.001f);
	}
	...
	void testPredict_3() {
		...
		assertEquals(1.9632298946380615f, actual, 0.001f);
	}
	...
	void testPredict_4() {
		...
		assertEquals(2.108529806137085f, actual, 0.001f);
	}
	...
	void testPredict_5() {
		...
		assertEquals(1.9274265766143799f, actual, 0.001f);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.143357515335083f, actual, 0.001f);
	}
	...
	void testPredict_7() {
		...
		assertEquals(2.1649575233459473f, actual, 0.001f);
	}
}
