 ...
 * (continuous). 30 estimators, max_depth=6, num_leaves=31, learning_rate=0.1, BRANCH_LEQ node mode, post_transform=NONE,
 * aggregate_function=SUM, 8 input features (MedInc, HouseAge, AveRooms, AveBedrms, Population, AveOccup, Latitude, Longitude). 1,830
...
class LightgbmRegressorHousingTest implements TestConstants {
	...
	void testPredict_0() {
		...
		assertEquals(2.998030424118042f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_1() {
		...
		assertEquals(1.9749292135238647f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_2() {
		...
		assertEquals(1.9958165884017944f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_3() {
		...
		assertEquals(2.1794064044952393f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.028780221939087f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_5() {
		...
		assertEquals(3.040454864501953f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.4876606464385986f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.7638490200042725f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.480772018432617f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.0153270959854126f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.9191454648971558f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.588853120803833f, actual, PREDICTION_PRECISION);
	}
}
