...
class LightgbmRegressorHousingTest {
	...
	void testPredict_0() {
		...
		assertEquals(2.998030424118042f, actual, 0.01f);
	}
	...
	void testPredict_1() {
		...
		assertEquals(1.9749292135238647f, actual, 0.01f);
	}
	...
	void testPredict_2() {
		...
		assertEquals(1.9958165884017944f, actual, 0.01f);
	}
	...
	void testPredict_3() {
		...
		assertEquals(2.1794064044952393f, actual, 0.01f);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.028780221939087f, actual, 0.01f);
	}
	...
	void testPredict_5() {
		...
		assertEquals(3.040454864501953f, actual, 0.01f);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.4876606464385986f, actual, 0.01f);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.7638490200042725f, actual, 0.01f);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.480772018432617f, actual, 0.01f);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.0153270959854126f, actual, 0.01f);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.9191454648971558f, actual, 0.01f);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.588853120803833f, actual, 0.01f);
	}
}
