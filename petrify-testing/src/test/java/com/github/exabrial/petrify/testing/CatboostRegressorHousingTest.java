...
class CatboostRegressorHousingTest implements TestConstants {
	...
	void testPredict_0() {
		...
		assertEquals(2.8243823051452637f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_1() {
		...
		assertEquals(1.8920303583145142f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.111334800720215f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_3() {
		...
		assertEquals(2.040360689163208f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.0152976512908936f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_5() {
		...
		assertEquals(3.043855667114258f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.630784034729004f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.7913987636566162f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.290546417236328f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_9() {
		...
		assertEquals(0.9178645610809326f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.9590823650360107f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.3191032409667969f, actual, PREDICTION_PRECISION);
	}
}
