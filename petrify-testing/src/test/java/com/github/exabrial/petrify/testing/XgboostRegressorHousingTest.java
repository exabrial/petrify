...
class XgboostRegressorHousingTest {
	...
	void testPredict_0() {
		...
		assertEquals(2.8574299812316895f, actual, 0.01f);
	}
	...
	void testPredict_1() {
		...
		assertEquals(2.077974557876587f, actual, 0.01f);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.2207913398742676f, actual, 0.01f);
	}
	...
	void testPredict_3() {
		...
		assertEquals(2.0591206550598145f, actual, 0.01f);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.005290150642395f, actual, 0.01f);
	}
	...
	void testPredict_5() {
		...
		assertEquals(3.0336570739746094f, actual, 0.01f);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.562894105911255f, actual, 0.01f);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.8151007890701294f, actual, 0.01f);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.477239608764648f, actual, 0.01f);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.017747163772583f, actual, 0.01f);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.8817468881607056f, actual, 0.01f);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.7884509563446045f, actual, 0.01f);
	}
}
