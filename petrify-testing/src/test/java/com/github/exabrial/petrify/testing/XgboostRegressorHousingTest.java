...
/**
 * Uses an XGBoost XGBRegressor exported to ONNX via onnxmltools, trained on California housing data to predict median house value
 * (continuous). 30 estimators, max_depth=4, learning_rate=0.1, BRANCH_LT node mode, post_transform=NONE, aggregate_function=SUM, 8
 * input features (MedInc, HouseAge, AveRooms, AveBedrms, Population, AveOccup, Latitude, Longitude). 930 total nodes (450 branch + 480
 * leaf). R²=0.73.
 */
@TestInstance(Lifecycle.PER_CLASS)
class XgboostRegressorHousingTest implements TestConstants {
	private static final String ONNX = "/test-models/xgboostRegressorHousing.onnx";
	...
	void testPredict_0() {
		...
		assertEquals(2.8574299812316895f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_1() {
		...
		assertEquals(2.077974557876587f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_2() {
		...
		assertEquals(2.2207913398742676f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_3() {
		...
		assertEquals(2.0591206550598145f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_4() {
		...
		assertEquals(1.005290150642395f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_5() {
		...
		assertEquals(3.0336570739746094f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_6() {
		...
		assertEquals(2.562894105911255f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_7() {
		...
		assertEquals(1.8151007890701294f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_8() {
		...
		assertEquals(4.477239608764648f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_9() {
		...
		assertEquals(1.017747163772583f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_10() {
		...
		assertEquals(1.8817468881607056f, actual, PREDICTION_PRECISION);
	}
	...
	void testPredict_11() {
		...
		assertEquals(1.7884509563446045f, actual, PREDICTION_PRECISION);
	}
}
